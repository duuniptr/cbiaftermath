...
The two main requirements for the project were a connection to TALENT and a relation to education. The brief was left  open, so that the multidisciplinary team could customize it to suit their specific set of skills. On a more detailed level, three different tracks were presented for the team to choose.
...
\bibitem{Shaer} Shaer,\ O.,  Hornecker, E. \textit{Tangible user interfaces: past, present, and future directions.} Foundations and Trends in Human-Computer Interaction 2010, Vol 3, Issue 1–2, p. 1-137.

\bibitem{Johnston} Johnston, A., Yoakum, J., Singh, K. \textit{Taking on webRTC in an enterprise.} Communications Magazine 2013, IEEE, Vol. 51, Issue 4, p. 48-54.
...
\bibitem{Rosenberg} Rosenberg, J. \textit{Interactive connectivity establishment (ICE): A protocol for network address translator (NAT) traversal for offer/answer protocols.} RFC 5245, April 2012. ietf.org

\bibitem{Frederick} Frederick, R., Jacobson, V., Design, P. \textit{RTP: A transport protocol for real-time applications.} IETF RFC3550. 2003 ietf.org
